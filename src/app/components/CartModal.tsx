...
export const CartModal = ()=>{
    ...
    return (
        <div className=" w-max absolute p-4 rounded-md shadow shadow-[0_3px_10px_rgb(0,0,0,0.2)] bg-white top-12 right-0 flex flex-col gap-6 z-20">
           {!cartItems && 
           <div className="text-cl">Cart is Empty</div>
           }
           <h2>Shopping Cart</h2>
           <div className="flex flex-col gap-8">
                <div className="flex gap-4">
                    <Image src="https://anmeshop.com/cdn/shop/files/products_stickerpack2_5_png_f5c35f9a-dd8f-4c34-956e-dd186b3f4468_1024x1024@2x.webp?v=1732574992" alt="" width={72} height={96} className="object-cover rounded-md"/>
